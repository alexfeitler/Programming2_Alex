...
for cur_pos in range(len(nba_leader_list[1])):
    min_pos = cur_pos
    for scan_pos in range(cur_pos + 1, len(nba_leader_list[1])):
        if nba_leader_list[1][scan_pos] > nba_leader_list[1][min_pos]:
            min_pos = scan_pos
        nba_leader_list[1][min_pos], nba_leader_list[1][cur_pos] = nba_leader_list[1][cur_pos], nba_leader_list[1][min_pos] # commits the change
